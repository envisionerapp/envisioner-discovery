...
const StreamersPage: React.FC = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto">
      ...
      <div className="card">
        <div className="card-header rounded-t-xl" style={{ paddingTop: '16px', paddingBottom: '16px', paddingLeft: '16px', paddingRight: '16px', background: '#FFFFFF' }}>
        ...
        <div className="fixed inset-0 z-50">
          ...
          <div className="absolute inset-y-0 right-0 w-full sm:w-[580px] card overflow-y-auto" style={{ boxShadow: '-4px 0 24px rgba(0,0,0,0.5)' }}>
            ...
            <div className="p-3 sm:p-5 space-y-4 sm:space-y-5">
              ...
              {/* Email Contact */}
              {(selected.email || selected.businessEmail) && (
                <div className="p-3 sm:p-4 rounded-xl border" style={{ background: '#FFFFFF', borderColor: 'rgba(20, 28, 46, 0.1)' }}>
                  <div className="flex items-center gap-2 mb-2 sm:mb-3">
